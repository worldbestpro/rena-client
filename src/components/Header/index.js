...
import logoSmallRena from 'assets/imgs/logo.png'
...
const Header = ({ border }) => {
  ...
  const [banCollectionModalVisible, setBanCollectionModalVisible] =
    useState(false)
  const [banItemModalVisible, setBanItemModalVisible] = useState(false)
  const [boostCollectionModalVisible, setBoostCollectionModalVisible] =
    useState(false)
    ...
    <div className={cx(styles.header, border && styles.hasBorder)}>
      <div className={styles.left}>
        <Link to="/" className={styles.logo}>
          <img src={logoSmallRena} alt="logo" />
          <span>Rena Finance</span>
        </Link>
