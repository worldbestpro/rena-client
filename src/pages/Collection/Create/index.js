        ...
        try {
          ...
          try {
            ...
            signature = await signer.signMessage(
              `Approve Signature on Rena.io with nonce ${nonce}`
            )
          } catch (err) {
            toast(
              'error',
        ...
        {isRegister && (
          <div className={styles.inputGroup}>
            <div className={styles.inputTitle}>
              Royalty *&nbsp;
              <BootstrapTooltip
                title="Each NFT under this collection exchanged through Rena will have a percentage of sale given to nominated wallet address."
                placement="top"
              >
                <HelpOutlineIcon />
              </BootstrapTooltip>
